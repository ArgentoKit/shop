    ...
    theme: {
        ...
        extend: {
            ...
            boxShadow: {
                ...
                greenXS: '1px 2px 4px 0px rgba(112,192,91,0.2)',
                greenS: '2px 4px 8px 0px rgba(112,192,91,0.2)',
                greenM: '4px 8px 16px 0px rgba(112,192,91,0.2)',
                greenL: '8px 16px 32px 0px rgba(112,192,91,0.2)',
                greenXL: '16px 32px 64px 0px rgba(112,192,91,0.2)',
            },
            fontSize: {
                xs: ['12px', '18px'],
                s: ['16px', '24px'],
